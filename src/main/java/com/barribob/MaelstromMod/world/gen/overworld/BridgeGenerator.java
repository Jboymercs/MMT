...
public class BridgeGenerator {
    ...
    public BridgeGenerator(IBridgeDataSupplier data, BlockPos start, BlockPos end) {
     ...
     */
    public BridgeGenerator(float tension, int width, BlockPos start, BlockPos end, IBlockState pathBlock, IBlockState fenceBlock, IBlockState railingBlock, IBlockState anchorBlock) {
